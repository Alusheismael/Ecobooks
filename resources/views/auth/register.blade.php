...
<head>
  ...
  <link href="{{ asset('css/register.css') }}" rel="stylesheet"> <!-- Incluir el CSS personalizado -->
          ...
          <div class="card">
            <div class="row g-0">
              <div class="col-md-6 col-lg-5 d-none d-md-block">
                <img src="{{ asset('images/fondoRegistro.jpg') }}"
                  alt="register form" class="img-fluid h-100" style="border-radius: 1rem 0 0 1rem; object-fit: cover;" />
              </div>
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form method="POST" action="{{ route('register') }}" autocomplete="off">
                    ...
                    <div class="form-outline mb-4">
                      <input type="text" id="email" class="form-control form-control-lg" name="email" placeholder="Ej: juan123@dominio.com" required autocomplete="off" />
